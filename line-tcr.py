...
➤[Set group]    Mengatur Privasi Grup
➤[Ban @]        Bann Target 
➤[Unban @]      Unbann Target
    ...
    try:
        ...
        if op.type == 26:
	      ...
	      if msg.from_ in admin:
            ...
            elif ("No2 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("No2 gn ","")
                    ki.updateGroup(X)
                else:
                    ki.sendText(msg.to,"It can't be used besides the group.")
            elif ("No3 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("No3 gn ","")
                    kk.updateGroup(X)
                else:
                    kk.sendText(msg.to,"It can't be used besides the group.")
            elif ("No4 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("No4 gn ","")
                    kc.updateGroup(X)
                else:
            ...
            elif "No2 kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("No2 kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "No3 kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("No3 kick ","")
                kk.kickoutFromGroup(msg.to,[midd])
            elif "No4 kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("No4 kick ","")
            ...
            elif "No3invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("No3invite ","")
                kk.findAndAddContactsByMid(midd)
                kk.inviteIntoGroup(msg.to,[midd])
            elif "No4invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("No4invite ","")
            ...
            elif msg.text in ["No3"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': Bmid}
                kk.sendMessage(msg)
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","No1 Gift"]:
                msg.contentType = 9
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","No2 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '6'}
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","No3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
                msg.text = None
                kk.sendMessage(msg)
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","No4 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '10'}
	      ...
	      if msg.from_ in admin:
            ...
            elif msg.text in ["cancelall","Bot cancel"]:
	      if msg.from_ in admin:
                if msg.toType == 2:
	      ...
	      if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["No2 ourl","No2 link on"]:
	      if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["No3 ourl","No3 link on"]:
	      if msg.from_ in admin:
                if msg.toType == 2:
            ...
            elif msg.text in ["No4 ourl","No4 link on"]:
	      if msg.from_ in admin:
                if msg.toType == 2:
	      ...
	      if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["No2 curl","No2 link off"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["No3 curl","No3 link off"]:
	      if msg.from_ in admin:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["No4 curl","No4 link off"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
		...
		for ticket_id in n_links:
	      ...
	      if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
            elif msg.text in ["Lockjoin on","lockjoin on"]:
              if msg.from_ in admin:
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Lockjoin off","lockjoin off"]:
              if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                if wait["Bankaimode"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Bankai sudah diaktifkan")
                    else:
                        cl.sendText(msg.to,"Bankai diaktifkan")
                else:
                    wait["Bankaimode"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Bankai sudah diaktifkan")
                    else:
                        cl.sendText(msg.to,"Bankai diaktifkan")
              ...
              if msg.from_ in admin:
                if wait["Bankaimode"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Bankai sudah dinonaktifkan")
                    else:
                        cl.sendText(msg.to,"Bankai dinonaktifkan")
                else:
                    wait["Bankaimode"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Bankai sudah dinonaktifkan")
                    else:
                        cl.sendText(msg.to,"Bankai dinonaktifkan")
	      ...
	      if msg.from_ in admin:
                ...
                if wait["Bankaimode"] == True: md+="􀔃􀆑lock􏿿   Block Group\n"
        ...
        #-------------Fungsi Jam on/off Start-------------------#            
	      ...
	      if msg.from_ in admin:
                if wait["clock"] == False:
                    kc.sendText(msg.to,"Bot jam off")
                else:
                    wait["clock"] = False
		...
		if msg.from_ in admin:
                    cl.sendText(msg.to, "Check point sudah diset.")
                    try:
		...
		if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "●▬▬▬ Dibaca Oleh ▬▬▬● %s\nBy : ɆsᵽȺđȺ ŦɇȺm\n\nOrang yang layak dimusnahkan\n%sAbnormal activity ♪\n\nReading point creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Espada","Bankai","Ban kai","ketinggalan"]:
              if msg.from_ in admin:
         ...
         #----------------Fungsi Banned Kick Target Start-----------------------#
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        kk.sendText(msg.to,"Done, Aizen-sama")
                        return
                        ...
                        for target in targets:
                          if target not in Bots:
                            try:
                                ...
                                ki.sendText(msg.to,"Bawa santai aja")

        #----------------Fungsi Kick User Target Start----------------------#
            elif "Cero " in msg.text:
                  if msg.from_ in admin:
                       nk0 = msg.text.replace("Cero ","")
                       nk1 = nk0.lstrip()
                       nk2 = nk1.replace("@","")
                       nk3 = nk2.rstrip()
                       _name = nk3
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Berhasil menghapus dari ban list")
                            except:
                                ki.sendText(msg.to,"Error")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
	      ...
	      if msg.from_ in admin:
                cl.sendText(msg.to,"Stark")
                ki.sendText(msg.to,"Barragan")
                kk.sendText(msg.to,"Tia")
                kc.sendText(msg.to,"Ulquiorra")
                ks.sendText(msg.to,"Nnoitra")
                ka.sendText(msg.to,"Grimmjow")
                kb.sendText(msg.to,"Zommari")
                ko.sendText(msg.to,"Szayel")
                ke.sendText(msg.to,"Aaroniero")
		ku.sendText(msg.to,"Yammy")
		cl.sendText(msg.to,"Semua sudah hadir aizen-sama")
      ...
      #-------------Fungsi Bannlist Finish------------------#  
	      ...
	      if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Blacklist sudah dimusnahkan")
