...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EnNZj4cpdsSjFMAQUHA5.nqZhqiZgZilGvU4eyth5jq.nm6lDrP7tiHj+wWElKikaABIAkzGiBq7rlVhwqLU/Fo=")
cl.loginResult()
#vidia
ki = LINETCR.LINE()
#kt.login(qr=True)
ki.login(token="EnyTpTVYCSl7Bk9Getxc.SJRuNecAXNC8sHurfor2ha.FvjQmaYhw1tQ7xg/BmYpNBh+d6/GM98WAGGHeBwJL24=")

#rosetta
kk = LINETCR.LINE()
#ks.login(qr=True)
kk.login(token="EnmhnzLQ3mGOI0P9gzC2.EX9POTYx+gKdjKz7DQlnSG.wiOX2CDfNnie7MC9gI5kq6gJvxjOwhJazmAz+JY9E4o=")
...
ks = LINETCR.LINE()
#kk.login(qr=True)
ks.login(token="En4h0sFpxwMPfD6ChHR7.7aNdCEtbMUaAO9Hiv0qoTW.EwvrBlT4AGk0WUShzVOzFa8HTbK5+NCK5zchxUL3+FQ=")

#iridessa
kt = LINETCR.LINE()
#kc.login(qr=True)
kt.login(token="EngTDozqKdQh9JOjYLG2.ZNOnP4uou95euS+Ku1ce4G.WFTpb9eSDQYp+dHlw/GRjS1HKUQXug5k7pbf5LT7TY8="
...
print "login success"
̸̴̨̧̧̨̛̛͍̟̯̞͙̙͍̜̯̰̞͍͖͓̲͇̤͔̝͕͍̮̳͎̝̣̈́̄̃̇̐̐́̐̆ͥ̑ͦ̓̓ͩ̎́̕͢͡͞ͅreload(sys)
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,"u350cc7408cc6cc82e056ee046131f925","ub23ad49c409ac6773c4a151114e4761c","u7b1f69a2dc97fc690326467b76a2cdb2","ueb040473fd4f50aa0b2ca56aee818b1d","uec09c371e4c19ae01aa3d84857440eb7","uce7a0da7850e53de4452cfe4535084e2"]
...
wait = {
    ...
    "lang":"JP",
    "comment":"AutoLike by Babang_adhi",
