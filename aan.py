        ...
        if op.type == 17:
            if op.param3 in wait["blacklist"]:
                if not op.param2 in Bots and admin: 
                    ...
                    cl.sendText(op.param1,"blacklist users are not allowed to sign in")
                    c = Message(to=op.param1, from_=None, text=None, contentType=13)
                     ...
                     if msg.from_ in admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 ...
                                 ki.sendText(msg.to,"Hubungi Owner Cogan \n➣Unban: " + invite)
                                 break                             
                             else:
                ...
                if msg.from_ in owner:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                admin.append(target)
                                cl.sendText(msg.to,"success add to adminlist")
                            except:
                                pass
                ...
                if msg.from_ in owner:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                admin.remove(target)
                                cl.sendText(msg.to,"Success remove admin from adminlist")
                            except:
                                pass
...
#=================================================================
              ...
              if msg.from_ in admin:
                if wait["protectionOn"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Bankai mode di aktifkan\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        cl.sendText(msg.to,"Bankai mode di aktifkan\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
...
#------------------------------------------------
		...
		zm.sendText(msg.to,"PONG ")
		sz.sendText(msg.to,"PONG ")
		ar.sendText(msg.to,"PONG ")
		ya.sendText(msg.to,"PONG ")
...
#=================================================
              ...
              if msg.from_ in admin:
                    cl.sendText(msg.to, "Set point ready.")
                    try:
...
#========================================
            elif msg.text in ["Espada","Bankai","Ban kai"]:
              if msg.from_ in admin:
...
#=====================================================================================
              ...
              if msg.from_ in admin:
                ...
                try:
                     ...
                     pass
            elif msg.text in ["Cero "]:
              if msg.from_ in admin:                                        
                       mk0 = msg.text.replace("Cero ","")
                       mk1 = mk0.lstrip()
                       mk2 = mk1.replace("@","")
                       mk3 = mk2.rstrip()
                       _name = mk3
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Success Masuk daftar Ban list")
                            except:
                                cl.sendText(msg.to,"Error")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Sudah di keluarkan dari daftar ban list")
                            except:
           ...
           for posts in cl.activity(1)["result"]["posts"]:
             if posts["postInfo"]["liked"] is False:
                if wait["likeOn"] == True:
                   ...
                   zm.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1001)
                   sz.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1001)
                   ar.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1001)
                   ya.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1001)
                   if wait["commentOn"] == True:
